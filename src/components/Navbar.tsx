  ...
  const projects = [
    {
      ...
      link: "https://milestones5-dusky.vercel.app/",
    },
    {
      title: "Project 2",
      description: "Resume.",
      link: "https://milestone1-phi-eight.vercel.app/",
    },
  ];
    ...
    <div>
      ...
      <header className="fixed top-0 left-0 w-full bg-gray-900 py-4 shadow-md z-10">
        <div className="container mx-auto flex justify-between items-center px-6">
          <h1 className="text-xl font-bold">Shahrukh's Portfolio</h1>
